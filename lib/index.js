// ../../../../usr/local/lib/node_modules/@deepseek-ai/dsh/node_modules/@deepseek-ai/cosmokit/lib/index.js
...
// src/index.ts
var name = "dsh-model-enhance";
var inject = ["settings"];
var PrefsSchema = Schema.object({
  providerLabel: Schema.boolean().default(false)
});
function apply(ctx) {

...
function ModelEnhanceSection({ api, t, onInvalidate }) {
  ...
  const setField = (providerName, modelId, field, raw) => {
...
function ProviderCard({ provider, t, onToggleModel, onToggleEffort, onSetField }) {
...
function ModelRow({ providerName, model, t, onToggleModel, onToggleEffort, onSetField }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `dsh_me_row${model.enabled ? "" : " dsh_me_row_dim"}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_me_fields", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh_me_field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_me_field_key", children: t("contextWindow") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh_me_field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_me_field_key", children: t("maxTokens") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            className: "dsh_me_field_value",
...
var zh = {
  "nav": "\u6A21\u578B\u589E\u5F3A",
  "title": "\u6A21\u578B\u589E\u5F3A",
  "subtitle": "\u6309\u63D0\u4F9B\u65B9\u4E0E\u6A21\u578B\u7F16\u8F91\u63A8\u7406\u5F3A\u5EA6\uFF08reasoningEfforts\uFF09\u3001\u4E0A\u4E0B\u6587\u7A97\u53E3\u4E0E\u6700\u5927\u8F93\u51FA token\uFF1B\u6539\u52A8\u5373\u65F6\u751F\u6548\u3002",
  "save": "\u4FDD\u5B58",
  "saving": "\u4FDD\u5B58\u4E2D\u2026",
  "saved": "\u5DF2\u4FDD\u5B58",
  "saveFailed": "\u4FDD\u5B58\u5931\u8D25",
...
var en = {
  "nav": "Model enhance",
  "title": "Model enhance",
  "subtitle": "Edit reasoningEfforts, context window, and max output tokens per provider and model; changes apply live.",
  "save": "Save",
  "saving": "Saving\u2026",
  "saved": "Saved",
  ...
  "fieldHint": "Leave empty to remove from configuration",
  "effort.off": "Off",
